...
Qompoter::InqludeLoader::InqludeLoader(const Query &query, QObject *parent) :
    ILoader(query, "http", parent),
    git_(query_),
    http_(query_)
{}

bool Qompoter::InqludeLoader::isAvailable(const RequireInfo &dependencyInfo, const RepositoryInfo &repositoryInfo) const
{
...
QList<Qompoter::RequireInfo> Qompoter::InqludeLoader::loadDependencies(const PackageInfo &packageInfo, bool &downloaded)
{
...
bool Qompoter::InqludeLoader::load(const PackageInfo &packageInfo)
{
